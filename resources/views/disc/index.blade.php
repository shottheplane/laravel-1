...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<title>我的评论 - 当当网</title>
		
                
                
                <!--广告通用css-->
		<script src="js3/s.js" async="" type="text/javascript"></script><script src="js3/mvl.js" async="" type="text/javascript"></script><script type="text/javascript" src="js3/jquery-1.7.1.min.js"></script>
                <meta name="ddclick_社区_我的评论页" content="time_limit:1|is_comment:0|page_index:1|pagesize:5|no:">
        
	
<link rel="stylesheet" type="text/css" href="css3/index.css" media="all">
</head>
...
<script src="js3/adv.js"></script><script type="text/javascript">
...
<script src="js3/pagetop2015_0827.js" charset="gb2312" type="text/javascript"></script>
<script src="js3/dd.menu-aim.js" charset="gb2312" type="text/javascript"></script>
...
<!--CreateDate  2016-09-28 09:00:01--><div style="position: relative;" class="logo_line_out">
<div class="logo_line" dd_name="搜索框">
    <div class="logo"><img src="{{ asset('image3/ddlogonew.gif') }}" usemap="#logo_link">
    ...
    <div class="search">
        <form action="http://search.dangdang.com/" name="searchform" id="form_search_new" onsubmit="return searchsubmit();" method="GET">
            <label for="key_S" class="label_search" id="label_key" onclick="this.style.color='rgb(255, 255, 255)';" style="visibility: visible; color: rgb(102, 102, 102);">下单立返100元现金券</label>
            <input value="" class="text gray" name="key" id="key_S" autocomplete="off" onclick="key_onclick(event);" onfocus="key_onfocus(event);" onblur="key_onblur();" onbeforepaste="onpaste_search();" type="text"><a href="javascript:void(0);" onclick="clearkeys();" class="del-keywords"></a><span class="select" onmouseover="allCategoryShow();" onmouseleave="allCategoryHide();" onmouseout="if(&quot;\v&quot;!=&quot;v&quot;){ allCategoryHide();}"><span id="Show_Category_Name" dd_name="全部分类">全部分类</span><span class="icon"></span>
                <div id="search_all_category" class="select_pop" style="height: 0px; padding: 0px; border-width: 0px;" dd_name="搜索分类">
                    <a href="javascript:void(0);" onclick="selectCategory('',this);"><span id="Show_Category_Name" dd_name="全部分类">全部分类</span></a>
                                        ...
                                        <a href="http://comm.dangdang.com/comment/01.00.00.00.00.00" dd_name="图书"><span>图书</span></a>
                                        <a href="http://comm.dangdang.com/comment/03.00.00.00.00.00" dd_name="音像"><span>音像</span></a>
                                        <a href="http://comm.dangdang.com/comment/05.00.00.00.00.00" dd_name="影视"><span>影视</span></a>
                                        <a href="http://comm.dangdang.com/comment/98.00.00.00.00.00" dd_name="数字商品"><span>数字商品</span></a>
            ...
            <input id="default_key" value="下单立返100元现金券" type="hidden">
    ...
    <div class="search_bottom">
        <div class="search_hot"><a href="http://www.dangdang.com/sales/brands/" target="_top" style="margin-right: 0px;">热搜</a>: <a href="http://search.dangdang.com/?key=%C1%AC%D2%C2%C8%B9&amp;act=hot" name="hotword" target="_top">连衣裙</a><a href="http://search.dangdang.com/?key=%D6%EC%E9F%BB%F9&amp;act=hot" name="hotword" target="_top">朱镕基</a><a href="http://search.dangdang.com/?key=%C5%AE%D7%B0%C7%EF%BC%BE%D0%C2%C6%B7&amp;act=hot" name="hotword" target="_top">女装秋季新品</a><a href="http://search.dangdang.com/?key=%C4%BE%CD%E8%D7%D3%BB%FD%C4%BE&amp;act=hot" name="hotword" target="_top">木丸子积木</a><a href="http://search.dangdang.com/?key=%BF%BC%D1%D0%B4%F3%B8%D9&amp;act=hot" name="hotword" target="_top">考研大纲</a><a href="http://search.dangdang.com/?key=%BA%A3%CD%E2%B9%BA&amp;act=hot" name="hotword" target="_top">海外购</a></div>
...
<div class="nav_top">
    <ul>
        <li class="all"><a href="http://category.dangdang.com/?ref=www-0-C" id="a_category" name="cate" class="sort_button" onmouseover="showCategory('a_category','__ddnav_sort','http://static.dangdang.com/js3/header2012/categorydata_new.js?2016092820160906');" onmouseout="closeCategory('__ddnav_sort');" dd_name="全部商品分类" target="_top">全部商品分类</a></li>
...
</script><script src="queryunpaid" type="text/javascript"></script>        <!--页头结束-->

    <!--广告区开始-->
        <!--广告区结束-->
    
 <div class="mydnew_break">您现在的位置：<a href="http://www.dangdang.com/">当当</a> &gt; <span><a href="http://myhome.dangdang.com/">我的当当</a></span> &gt; <span>我的评论</span> </div> 
...
</li></ul><h3 class="mydang_left_title">个人中心<a class="slide_up" id="class640" href="javascript:void(click_a('class640','display640'))"></a></h3><ul class="my_content" style="display: block;" id="display640"><li><a class="" target="_parent" href="http://customer.dangdang.com/profile/" name="profileleft">个人信息</a>
...
</li></ul><h3 class="mydang_left_title">社区<a class="slide_up" id="class650" href="javascript:void(click_a('class650','display650'))"></a></h3><ul class="my_content" style="display: block;" id="display650"><li><a href="http://comm.dangdang.com/review/reviewbuy.php" class="on">评论/晒单</a>
...
<div id="callbackjs"><script src="doccallbackjs.aspx" type="text/javascript"></script></div>
  ...
  document.domain = "dangdang.com";
                ...
                <!--左栏结束-->
            <!--右栏开始-->
            <div class="main_right mycomment">
                <!--积分开始-->
                <div class="level clearfix">
    <div class="level_main left">
                        <h2>写评论，赚积分，兑换礼券！评论内容越丰富积分越多！</h2>
                        <div class="level_content clearfix">
                            <ul>
                                <li class="title">积分：</li>
                                <li class="view">
                                    <p class="bg rather_bg review_icon">
                                        <i style="width: 0%;" node="0.0%" class="rather review_icon"></i>
                                    </p>
                                    <span class="tip">还差<b class="red">15000</b>积分可以兑换<b class="red">5元</b>礼券</span>
                                    <span class="red right">0/15000</span>
                                </li>
                            </ul>
                        </div>
                        <div class="level_bottom">
                            <a target="_top" href="http://misc.dangdang.com/gifts/index.aspx?pmax=7565&amp;ref=my-11-A#giftlist" class="convert review_btn" title="兑换礼券"></a>
                            <span>未到账积分：0</span>
                            <a target="_top" class="right" href="http://support.dangdang.com/helpcenter/api_cms/helpcenter/question_sort/2247/180130.shtml#10" title="积分规则">积分规则&gt;&gt;</a>
                        </div>
                    </div>
                    <div class="level_main right">
                        <h2>评论数量越多等级越高，赚的积分越多！</h2>
                        <div class="level_content clearfix">
                            <ul>
                                <li class="title">等级：</li>
                                <li class="view">
                                    <p class="bg leave_bg review_icon">
                                        <i style="width: 0%;" node="0%" class="leave review_icon"></i>
                                    </p>
                                    <span class="tip">还差<b class="green">1</b>条评论升级 <b class="green">评论达人V1</b></span>
                                    <span class="green right">0/0</span>
                                </li>
                            </ul>
                        </div>
                        <div class="level_bottom">
                            <span>当前您的等级为：评论达人V1</span>
                            <a target="_top" class="right" href="http://support.dangdang.com/helpcenter/api_cms/helpcenter/question_sort/2247/180130.shtml#10" title="等级规则">等级规则&gt;&gt;</a>
                        </div>
                    </div>  
</div>
                <!--积分结束-->
                <div class="select_title">
                    <select name="time_limit" id="time_limit" style="width: 85px;">
                        <option value="1">30天以内</option>
                        <option value="2">3个月以内</option>
                        <option value="3">2016年</option>
                        <option value="4">2015年</option>
                        <option value="5">更早</option>
                    </select>
                    <select name="is_comment" id="is_comment" style="width: 65px;">
                        <option value="0">待评论</option>
                ...
                <div class="order_all">
                           ...
                           <h4> 很抱歉，没有找到相关的订单信息</h4>
                           <p> 您可以调整查找的时间范围、评论状态继续搜索</p>
                        </div>
                                    </div>
                <!--分页-->
                                 <div class="page_bottom"></div>
            </div>
            <script type="text/javascript" src="js3/comm.js"></script>
            <script type="text/javascript" src="js3/my_appraisal.js"></script>
            <!--右栏结束-->
		</div>		
        <!--页脚开始-->
            <div id="footer">
...
<script>
    ...
    function hidehotsearch(){
		...
		<div class="footer_copyright"><span>Copyright (C) 当当网 2004-2016, All Rights Reserved</span><a href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202001051000098" target="_top" class="footer_img" rel="nofollow"><img src="{{ asset('image3/validate.gif') }}"></a><span><a href="http://www.miibeian.gov.cn/" target="_top" rel="nofollow">京ICP证041189号</a></span><span>出版物经营许可证 新出发京批字第直0673号</span></div>
	</div>
</div>
</div>
<div id="footer_end"></div>
<!--CreateDate  2016-09-28 10:00:01-->    <div class="foot_tip_ad">广告</div>
    
<script src="js3/check_snbrowse.js" type="text/javascript"></script>
<script type="text/javascript">login_session.browsePageOperate();</script>
<script type="text/javascript" src="js3/js_tracker.js"></script>
<script type="text/javascript">
//MediaV
var _mvq = _mvq || [];
...
mvl.src = ('https:' == document.location.protocol ? 'http://static.dangdang.com/js3/header2012/mvl.js' : 'http://static.dangdang.com/js3/header2012/mvl.js');
...
<noscript><img src="//stats.teller.cn/adv.gif?a=xT..hNvyCM_tldiECftJyo-LKP&e=" style="display:none;"/></noscript><script type="text/javascript">
var _bdhmProtocol = (("https:" == document.location.protocol) ? " https://" : " http://");
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fb3317b708e34762acd165e46c6507f18' type='text/javascript'%3E%3C/script%3E"));
</script><script src="js3/h.js" type="text/javascript"></script>
<!--  .46.184 -->        <!--页脚结束-->
        <!-- 
.46.184
source
 -->        
<iframe id="mv_cm" src="index_2.html" style="width: 1px; border: 0px none; position: absolute; left: -100px; top: -100px; height: 1px;"></iframe></body>
</html>
