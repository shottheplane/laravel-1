...
function initHeaderOperate()
{
    ...
    if(validatedflag=="1")
        marks = "<a name=\"ddnav_verifymail\" href=\"https://login.dangdang.com/VerifyEmail.aspx\">(未验证)</a>";
...
function showCategory(aid,did,json_url){
    ...
    divotherChannel.style.height="481px";
   ...
   // }
    ...
    var changeW=function(){
          ...
          if(obj_h<=480){
            divotherChannel.style.height=parseInt(obj_h+Math.ceil((481-obj_h)/14))+"px";
          }else{
